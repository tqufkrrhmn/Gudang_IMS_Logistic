<?php
// app/views/receipts/receipt_list.php
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Penerimaan Barang - Gudang IMS</title>
...
<div class="container-main">
    ...
    <div class="page-header">
        ...
        <a href="index.php?route=receiving/create" class="btn-create">+ Tambah Penerimaan</a>
    </div>
    ...
    <div class="table-container">
        <?php if (empty($receipts)): ?>
            <div class="empty-state">
                ...
                <h5>Tidak ada penerimaan ditemukan</h5>
                <p>Mulai dengan membuat penerimaan barang baru.</p>
            </div>
        <?php else: ?>
